...
function openDetailPopup(stock) {
  ...
  const imgEl = document.getElementById('wm-detail-popup-img');
  if (imgEl) {
  ...
  set('wm-detail-popup-brand', shopName);
  ...
  document.getElementById('wm-detail-overlay')?.classList.add('open');
  document.getElementById('wm-detail-popup')?.classList.add('open');
}

function closeDetailPopup() {
  _detailStock = null;
  document.getElementById('wm-detail-overlay')?.classList.remove('open');
  document.getElementById('wm-detail-popup')?.classList.remove('open');
}
...
function openOrderPopup(stock) {
  ...
  const itemEl = document.getElementById('wm-order-popup-item');
  const priceEl = document.getElementById('wm-order-popup-price');
  if (itemEl) itemEl.textContent = stock.item_name;
  if (priceEl) priceEl.textContent = `฿${Number(stock.price).toLocaleString('th-TH')}`;
  document.getElementById('wm-order-overlay')?.classList.add('open');
  document.getElementById('wm-order-popup')?.classList.add('open');
}

function closeOrderPopup() {
  _pendingOrderStock = null;
  document.getElementById('wm-order-overlay')?.classList.remove('open');
...
export const Market = {
  async init() {
    ...
    document.getElementById('wm-search')?.addEventListener('input', e => {
      _mktSearch = e.target.value;
      mktRender();
    });

    document.getElementById('wm-sort')?.addEventListener('change', e => {
      _mktSort = e.target.value;
      mktRender();
    });

    const priceRange = document.getElementById('wm-price-range');
    const priceDisplay = document.getElementById('wm-price-display');
    ...
    document.getElementById('wm-filter-available')?.addEventListener('change', e => {
      _mktShowAvail = e.target.checked;
      mktRender();
    });

    document.getElementById('wm-filter-outofstock')?.addEventListener('change', e => {
      _mktShowOut = e.target.checked;
      mktRender();
    });

    // Detail popup bindings
    document.getElementById('wm-detail-overlay')?.addEventListener('click', closeDetailPopup);
    document.getElementById('wm-detail-close-btn')?.addEventListener('click', closeDetailPopup);
    document.getElementById('wm-detail-popup-order-btn')?.addEventListener('click', () => {
      if (_detailStock) openOrderPopup(_detailStock);
    });

    // Order popup bindings
    document.getElementById('wm-order-overlay')?.addEventListener('click', closeOrderPopup);
    document.getElementById('wm-order-popup-cancel')?.addEventListener('click', closeOrderPopup);
    document.getElementById('wm-order-popup-confirm')?.addEventListener('click', async () => {
    ...
    document.getElementById('wm-grid')?.addEventListener('click', e => {
    ...
    const filterSidebar = document.getElementById('wm-filter-sidebar');
    const filterBackdrop = document.getElementById('wm-filter-backdrop');
    ...
    document.getElementById('wm-filter-toggle-btn')?.addEventListener('click', () => {
      filterSidebar?.classList.contains('open') ? closeFilter() : openFilter();
    });
    document.getElementById('wm-filter-close-btn')?.addEventListener('click', closeFilter);
